...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SupervisorServiceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(SupervisorServiceException ex){
    ...
    private ErrorMessage createError(SupervisorServiceException ex){
