...
<h2 style="color: #333">Your Advance request dated ${requestCreatedAt} has been processed. Please find the details of your Advance request below:</h2>
<hr>
<p style="color: #666">Description: ${requestDescription} </p>
<p style="color: #666">Amount: ${requestAmount} </p>
