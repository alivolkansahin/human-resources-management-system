...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DayOffServiceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(DayOffServiceException ex){
    ...
    private ErrorMessage createError(DayOffServiceException ex){
