...
public class JwtTokenManager {
    ...
    @Value("${day-off-service-config.jwt.issuer}")
    String issuer;

    @Value("${day-off-service-config.jwt.secret-key}")
    String secretKey;
    ...
    public List<String> getClaimsFromToken(String token){
        ...
        if(optionalId.isEmpty() || optionalRole.isEmpty()) throw new DayOffServiceException(ErrorType.INVALID_TOKEN);
    ...
    private DecodedJWT decodeToken(String token) {
        ...
        try {
            ...
            throw new DayOffServiceException(ErrorType.INVALID_TOKEN);
        }
    }
