...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SpendingServiceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(SpendingServiceException ex){
    ...
    private ErrorMessage createError(SpendingServiceException ex){
