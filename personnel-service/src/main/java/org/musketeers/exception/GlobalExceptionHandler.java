...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PersonnelServiceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(PersonnelServiceException ex){
    ...
    private ErrorMessage createError(PersonnelServiceException ex){
