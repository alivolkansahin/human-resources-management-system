...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Your DayOff request dated ${requestCreatedAt} has been processed. Please find the details of your DayOff request below:</p>
        <hr>
        <p><strong>Reason:</strong> ${requestReason}</p>
        <p><strong>Description:</strong> ${requestDescription}</p>
        <p><strong>Start Date:</strong> ${requestStartDate}</p>
        <p><strong>End Date:</strong> ${requestEndDate}</p>
