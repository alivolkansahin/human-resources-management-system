...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Your Advance request dated ${requestCreatedAt} has been processed. Please find the details of your Advance request below:</p>
        <hr>
        <p><strong>Description:</strong> ${requestDescription}</p>
        <p><strong>Amount:</strong> ${requestAmount}</p>
